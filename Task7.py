...
class CrossCorrelationApp:
    def __init__(self, root):
        ...
        self.calculate_button = ttk.Button(root, text="Calculate", command=self.calculate_correlation)
        ...
        self.correlation_listbox.grid(row=4, column=0, padx=10, pady=10)
        self.correlation_listbox_label = ttk.Label(root, text="Correlation Array:")
        self.correlation_listbox_label.grid(row=3, column=0, padx=10, pady=10)

        self.norm_correlation_listbox = tk.Listbox(root, selectmode=tk.SINGLE)
        self.norm_correlation_listbox.grid(row=4, column=1, padx=10, pady=10)
        self.norm_correlation_listbox_label = ttk.Label(root, text="Normalized Correlation Array:")
        self.norm_correlation_listbox_label.grid(row=3, column=1, padx=10, pady=10)
